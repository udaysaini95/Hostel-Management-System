...
`/api/complaints`, `/api/audit-events`, `/api/leave`, `/api/mess`, and `/api/gate`.
...
activation, student profiles, audit searches, complaints, leave applications,
mess operations, and gate actions.
