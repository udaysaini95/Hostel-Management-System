...
const MessPage = () => {
  ...
  const [issuesLoading, setIssuesLoading] = useState(isStudent);
  ...
  return (
    <div className="hm-page-stack hm-page-stack--wide hm-mess-page">
      <PageHeader
        ...
        description={
          isStudent
            ? "Check published meals by date, share a rating, or report a service issue."
            : "Check published hostel meals and dining schedules by date."
        }
      />
