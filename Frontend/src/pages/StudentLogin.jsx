...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("user", JSON.stringify(res.data.user || { name: email.split("@")[0], email }));
        ...
        <div className="ui-panel p-6 sm:p-8 rounded-2xl bg-white border-slate-200 shadow-sm">
          ...
          <div className="mt-6 text-center border-t border-slate-100 pt-4">
            <p className="text-xs text-slate-500">
              ...
              <Link to="/student/register" className="text-indigo-600 hover:underline font-semibold">
                Register
              </Link>
            </p>
          </div>
